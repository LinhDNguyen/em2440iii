...
@ -I/opt/em2440-iii/kernel/arch/arm/include -Iarch/arm/mach-s3c2410/include
...
@ -Iarch/arm/plat-s3c/include -imultilib armv4t -iprefix
@ /opt/Boardcon/4.3.3/bin/../lib/gcc/arm-none-linux-gnueabi/4.3.3/
@ -isysroot /opt/Boardcon/4.3.3/bin/../arm-none-linux-gnueabi/libc
@ -D__KERNEL__ -D__LINUX_ARM_ARCH__=4 -Uarm -DKBUILD_STR(s)=#s
@ -DKBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -DKBUILD_MODNAME=KBUILD_STR(asm_offsets) -isystem
@ /opt/Boardcon/4.3.3/bin/../lib/gcc/arm-none-linux-gnueabi/4.3.3/include
